...
const EstadisticasUsuario = ({ idUsuario }) => {
    ...
    const fetchEstadisticas = async () => {
        try {
            const [unoVsUnoResponse, quizResponse, mundialResponse] = await Promise.all([
                fetch(`https://momdel.es/animeWorld/api/estadisticasUsuarioJuegoUnovsUno.php?id=${idUsuario}`),
                fetch(`https://momdel.es/animeWorld/api/estadisticasUsuarioJuegoQuiz.php?id=${idUsuario}`),
                fetch(`https://momdel.es/animeWorld/api/estadisticasUsuarioJuegoMundial.php?id=${idUsuario}`)
            ]);
