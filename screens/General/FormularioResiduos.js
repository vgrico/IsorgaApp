...
const FormularioGestiones = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.area}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Formulario de Gestiones</Text>
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        {/* Campo para seleccionar una gestión */}
        <View style={styles.inputContainer}>
          <Text style={styles.label}>Seleccionar Gestión</Text>
...
export default FormularioGestiones;
