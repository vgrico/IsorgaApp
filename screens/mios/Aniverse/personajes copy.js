...
const Personajes = ({ navigation }) => {
    ...
    const renderContent = () => {
        ...
        const [personajes, setPersonajes] = useState([]) // Cambiado 'personaje' a 'personajes' para reflejar una lista
        ...
        const listarPersonajes = async () => {
            try {
                const response = await fetch(
                    'https://momdel.es/animeWorld/api/listadoPersonajes.php'
                )
                ...
                setPersonajes(datos)
                setPersonajesCount(datos.length)
            } catch (error) {
