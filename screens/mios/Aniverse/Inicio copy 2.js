...
const InicioPruebas = ({ navigation }) => {
    ...
    const [selectedButton, setSelectedButton] = useState(1); // Botón seleccionado (1 o 2)
    ...
    useEffect(() => {
        // Función para cargar las curiosidades
        ...
        // Si hay un userId válido, cargar las curiosidades
        if (userId) {
            fetchCuriosidades();
        }
            ...
            <View style={[styles.container, { backgroundColor: COLORS.white }]}>
                ...
                <View style={styles.additionalButtonsContainer}>
                    <TouchableOpacity 
                        ...
                        style={[styles.button, selectedButton === 1 ? styles.selectedButton : null]}
                    >
                        <Text style={styles.additionalButtonText}>Button 1</Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                        onPress={() => handleButtonPress(2)} 
                        style={[styles.button, selectedButton === 2 ? styles.selectedButton : null]}
                    >
                        <Text style={styles.additionalButtonText}>Button 2</Text>
                    </TouchableOpacity>
                </View>
                <ScrollView
                ...
                >
                    {renderContentForButton1()}
                    {renderContentForButton2()}
                </ScrollView>
            </View>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    additionalButtonsContainer: {
        ...
        borderColor: COLORS.border, // Color de la línea inferior
        paddingBottom: 8, // Espacio entre la línea inferior y los botones
    },
    button: {
        flex: 1, // Ocupa todo el espacio disponible
        alignItems: 'center',
        paddingVertical: 8, // Espacio vertical dentro del botón
    },
    ...
    selectedButton: {
        borderBottomWidth: 2, // Línea inferior adicional para el botón seleccionado
        borderColor: COLORS.primary, // Color de la línea inferior del botón seleccionado
    },
})

export default InicioPruebas
