...
import { categories, facilities, ratings, recommendedEvents } from '../../data';
...
const PopularEvents = ({ navigation }) => {
    ...
    */
    const renderContent = () => {
        ...
        const [filteredEvents, setFilteredEvents] = useState(recommendedEvents);
        ...
        const handleSearch = () => {
            const events = recommendedEvents.filter((event) =>
