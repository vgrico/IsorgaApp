...
const DocumentoPQ = ({ route, navigation }) => {
  ...
  const fetchDocumento = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://isorga.com/api/documentoPQ.php", {
        method: "POST",
        headers: {
  ...
  const renderHeader = () => {
    return (
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>DOCUMENTO P.Q.</Text>
        <View style={{ flex: 1 }} />
  ...
  return (
    <SafeAreaView style={styles.area}>
      ...
      <Text style={styles.cardTitle}>DOCUMENTO P.Q.</Text>
