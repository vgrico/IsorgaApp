...
const ManualDocumentos = ({ route, navigation }) => {
    ...
    const fetchModulosUsuario = async () => {
        try {
            ...
            const response = await fetch(
                'https://isorga.com/api/ManualCentros.php',
                {
                    method: 'POST',
                    headers: {
    ...
    const renderHeader = () => {
        return (
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.headerTitle}>MANUALES Y DOCUMENTOS</Text>
                <View style={{ flex: 1 }} />
        ...
        return (
            ...
            >
                <View style={styles.row}>
                    ...
                    <Text style={[styles.cell, styles.revisionCell]}>{item.laRevision ? item.laRevision.revision : 'N/A'}</Text>
                </View>
            </TouchableOpacity>
        );
    };
        ...
        <SafeAreaView style={styles.area}>
            ...
            <View style={styles.table}>
                <View style={styles.headerRow}>
                    ...
                    <Text style={[styles.headerCell, styles.revisionCell]}>Rev</Text>
                </View>
                <FlatList
...
export default ManualDocumentos;
