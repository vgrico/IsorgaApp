...
import CardRevisiones from '../../components/isorga/CardRevisiones';  

const RevisionesEquipos = ({ route, navigation }) => {
    ...
    const fetchModulosUsuario = async () => {
        try {
            ...
            const response = await fetch(
                'https://isorga.com/api/revisionesEquipos.php',
                {
                    method: 'POST',
                    headers: {
    ...
    const renderHeader = () => {
        return (
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.headerTitle}>REVISIONES</Text>
                <View style={{ flex: 1 }} />
...
export default RevisionesEquipos;
